...
public class NotAcceptedValueStringTest extends AbstractConstraintValidatorTest{

    @Test
    public void isValid_shouldReturnTrue_whenObjectIsNull() throws NoSuchFieldException {
        // GIVEN instance
        NotAcceptedValueStringValidator validator = new NotAcceptedValueStringValidator(dynamicConfiguration);
    ...
    public void isValid_shouldReturnFalse_whenValueIsInNotAcceptedValueList() throws NoSuchFieldException {
        ...
        verifyAddMesssageParameter("value", "X");
    }
